...
namespace OpenGC {
  MessageableList *MessageableList::m_instance = nullptr;
  
  MessageableList::MessageableList(void) {
  }

  MessageableList::~MessageableList() {
  }

  MessageableList *MessageableList::getInstance(void) {
    if (nullptr == m_instance) {
      m_instance = new MessageableList();
    }
